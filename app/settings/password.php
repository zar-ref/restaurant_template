...
if (isset($_POST['submit'])) //ver se a a mudança foi submited
{
	// get data
	...
	// validate data
	if ($_POST['oldpass'] == '' || $_POST['newpass'] == '' || $_POST['newpass2'] == '')//se alggum nao tiver preenchdio
	{
		if ($_POST['oldpass'] == '') { $FP->Template->setData('error_oldpass', 'required field!'); } //colocar os erros
